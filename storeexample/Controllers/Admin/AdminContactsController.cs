...
namespace storeexample.Controllers.Admin
{
    public class AdminContactsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContactId,FirstName,LastName,DisplayName,IsFullNameVisible,Phone,Email,ContactType")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContactId,FirstName,LastName,DisplayName,IsFullNameVisible,Phone,Email,ContactType")] Contact contact)
        {
            if (ModelState.IsValid)
            {
